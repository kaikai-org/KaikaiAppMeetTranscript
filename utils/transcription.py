...
# Charger le pipeline de reconnaissance vocale avec la langue spécifiée comme anglais
...
def transcribe_audio(audio_data):
    # Lire les données audio en mémoire
    ...
    now = datetime.now()
    filename = now.strftime("./transcript_notes/meet_transcript_%Y%m%d_%H%M%S.txt")
